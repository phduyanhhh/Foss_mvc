...
public abstract class FossWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static FossWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(FossWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<FossDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<FossDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<FossDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<FossDbContext, Task<T>> func)
    {
        T result;
